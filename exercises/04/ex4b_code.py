...
for func in [play_randomly, play_greedy_with_random, play_greedily]:
    for i in range(1,31):
        for j in range(1,101):
            ...
            if creature.score > 0:
                ...
                ex4_dict[str(func).split(" ")[1] + " " + str(i) +" "+ str(j)] = pd.DataFrame([[str(func).split(" ")[1],
                                      ...
                                      creature.score]],
                                      columns = ["Treatment_Function","Replicate_Num","Step_Num","X_Location","Y_Location","Score"])
            else:
                break
        #resetting the creature at the end of every game
        creature.reset()
